...
class I_EUDF35_A_Heli_EC_02_RF: I_EUDF35_Heli_EC_02_RF
{
    author = "kenoxite";
    scope = 2;
    scopeCurator = 2;
    ...
    editorPreview = "\EUDF35_core_F\data\previews\I_EUDF35_A_Heli_EC_02_RF.jpg";
...
class I_EUDF35_A_Heli_EC_01A_military_RF: I_EUDF35_Heli_EC_01A_military_RF
{
    author = "kenoxite";
    scope = 2;
    scopeCurator = 2;
    side = 2;
    faction = "IND_EUDF35_A_F";
    editorPreview = "\EUDF35_core_F\data\previews\I_EUDF35_A_Heli_EC_01A_military_RF.jpg";
    crew = "I_EUDF35_A_HeliPilot_F";
    dlc = "rf";
