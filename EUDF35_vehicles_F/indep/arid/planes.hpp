...
class I_EUDF35_D_Plane_Fighter_04_F : I_EUDF35_Plane_Fighter_04_F
{
    author = "kenoxite";
    scope = 2;
    scopeCurator = 2;
    ...
    editorPreview = "\EUDF35_core_F\data\previews\I_EUDF35_D_Plane_Fighter_04_F.jpg";
    crew = "I_EUDF35_D_Fighter_Pilot_F";
